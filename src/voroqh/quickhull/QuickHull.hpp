...
namespace quickhull {
	...
	struct DiagnosticsData {
		...
		double m_time_setup_micro = 0;
		double m_time_process_micro = 0;
		double m_time_total_micro = 0;
	...
	class QuickHull {
		...
		// Buffers for HalfEdgeMesh conversion to avoid reallocation
		std::vector<size_t> m_faceMapping;
		std::vector<size_t> m_halfEdgeMapping;
		std::vector<size_t> m_vertexMapping;
